...
export default function FloatLabelTextArea({ id, prompt, defaultValue, val } : FloatLabelTextAreaProps) : React.JSX.Element {
    ...
    return(
        <div className="relative mb-4 mt-3">
            <textarea id={id} name={id} value={value} className="peer h-50 p-2 w-full rounded-md placeholder-transparent border border-gray-300 text-gray-800 outline-none focus:border-[3px] focus:border-blue-400 focus:ring-0" placeholder={prompt} onChange={validate} onBlur={validate} defaultValue={defaultValue}/>
